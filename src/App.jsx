...
function App() {
  ...
  const modeLabels = {
    ...
    MOVE: 'MOVENDO',
    CTRL_MOVE: 'MOVER',
    CTRL_SCALE: 'REDIMENSIONAR',
    CTRL_ROTATE: 'ROTACIONAR',
  };

  const rawMode = controlGesture !== CONTROL_GESTURES.IDLE ? controlGesture : gesture;
  const activeMode = rawMode;
    ...
    <div className="app-container">
      ...
      {!landmark && !controlLandmark && (
        <div className="overlay-message">
          👋 Levante a mão para começar a desenhar
        </div>
      )}
    </div>
  );
